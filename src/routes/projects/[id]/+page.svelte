    ...
    <div>
      <div class="author">
        <a class="author" href="/users/{data.author.username}">
          <img src="https://ampmod.vercel.app/internalapi/users/{data.author.username}/get_image" alt={data.author.username} class="pfp">
          <div>
  ...
  {#each data.comments as comment}
    <div id="comment-{comment.id}">
      <a class="author" href="/users/{comment.author.username}">
        <img src="https://ampmod.vercel.app/internalapi/users/{comment.author.username}/get_image" alt={comment.author.username} class="pfp">
        <div>
