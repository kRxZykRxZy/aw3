        ...
        if (orphanBlock.isShadow()) {
            ...
            while (newBlock.nextConnection) {
                ...
                if (nextBlock && !nextBlock.isShadow()) {
                    ...
                    if (
                        orphanBlock.previousConnection.checkType_(
                ...
                setTimeout(function () {
                    ...
                    if (orphanBlock.workspace && !orphanBlock.getParent()) {
                        ...
                        if (orphanBlock.outputConnection) {
                            orphanBlock.outputConnection.bumpAwayFrom_(
                                parentConnection
                            );
                        } else if (orphanBlock.previousConnection) {
                            orphanBlock.previousConnection.bumpAwayFrom_(
                                parentConnection
                            );
                        }
...
Blockly.Connection.prototype.checkConnection_ = function (target) {
    switch (this.canConnectWithReason_(target)) {
        ...
        case Blockly.Connection.REASON_CHECKS_FAILED:
            ...
            msg +=
                this + " expected " + this.check_ + ", found " + target.check_;
            throw msg;
