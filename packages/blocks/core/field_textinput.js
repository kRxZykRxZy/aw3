    ...
    if (opt_withArrow) {
        ...
        if (this.sourceBlock_.RTL) {
            htmlInput.style.paddingLeft =
                this.arrowSize_ +
                Blockly.BlockSvg.DROPDOWN_ARROW_PADDING +
                "px";
        } else {
    ...
    if (e.type === "keypress" && this.restrictor_) {
        ...
        if (goog.userAgent.GECKO) {
            ...
            if (keyCode < 32 || keyCode == 127) {
                ...
                isWhitelisted =
                    Blockly.FieldTextInput.GECKO_KEYCODE_WHITELIST.indexOf(
                        keyCode
                    ) > -1;
            }
        } else {
    ...
    return function () {
        ...
        if (thisField.sourceBlock_) {
            if (thisField.sourceBlock_.isShadow()) {
                ...
                div.style.height =
                    Blockly.BlockSvg.FIELD_HEIGHT_MAX_EDIT + 1 + "px";
            }
        }
