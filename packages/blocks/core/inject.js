...
Blockly.createDom_ = function (container, options) {
  ...
  */
    ...
    options.gridPattern = Blockly.Grid.createDom(
        rnd,
        options.gridOptions,
        defs
    );
            ...
            if (!mainWorkspace.isDragging()) {
                ...
                if (
                    ...
                    for (var b = 0, block; (block = blocks[b]); b++) {
                        ...
                        var overflowTop =
                            edgeTop + MARGIN - blockHW.height - blockXY.y;
                        if (overflowTop > 0) {
